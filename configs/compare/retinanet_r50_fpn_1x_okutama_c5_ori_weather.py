_base_ = [
    ...
    '../_base_/datasets/okutama_detection_c5.py',
...
train_pipeline = [
    ...
    dict(type='Resize', img_scale=(1333, 800), keep_ratio=True, weather=True, weather_scale=(800, 1067, 3)),
...
test_pipeline = [
    ...
    dict(
        ...
        flip=False,
        transforms=[
            dict(type='Resize', keep_ratio=True, weather=True, weather_scale=(800, 1067, 3)),
