...
class ATTN_10_FPN(BaseModule):
    ...
    def __init__(self,
        ...
        super(ATTN_10_FPN, self).__init__(init_cfg)
        ...
        self.number_f=256
        self.w_conv1_1 = nn.Conv2d(256,self.number_f,3,1,1,bias=True)
        # self.w_conv2_1 = nn.Conv2d(self.number_f,self.number_f,3,1,1,bias=True) 
        ...
        self.w_conv7_1 = nn.Conv2d(self.number_f,256,3,1,1,bias=True) 
        self.w_conv8_1 = nn.Conv2d(self.number_f,256,3,1,1,bias=True) 

        self.w_conv1_2 = nn.Conv2d(256,self.number_f,3,1,1,bias=True)
        # self.w_conv2_2  = nn.Conv2d(self.number_f,self.number_f,3,1,1,bias=True) 
        # self.w_conv3 = nn.Conv2d(self.number_f*2,self.number_f,3,1,1,bias=True) 
        # self.w_conv4 = nn.Conv2d(self.number_f*2,self.number_f,3,1,1,bias=True) 
        # self.w_conv5 = nn.Conv2d(self.number_f*2,self.number_f,3,1,1,bias=True) 
        self.w_conv7_2  = nn.Conv2d(self.number_f,256,3,1,1,bias=True) 
        self.w_conv8_2  = nn.Conv2d(self.number_f,256,3,1,1,bias=True) 

        self.w_conv1_3  = nn.Conv2d(256,self.number_f,3,1,1,bias=True)
        # self.w_conv2_3  = nn.Conv2d(self.number_f,self.number_f,3,1,1,bias=True) 
        # self.w_conv3 = nn.Conv2d(self.number_f*2,self.number_f,3,1,1,bias=True) 
        # self.w_conv4 = nn.Conv2d(self.number_f*2,self.number_f,3,1,1,bias=True) 
        # self.w_conv5 = nn.Conv2d(self.number_f*2,self.number_f,3,1,1,bias=True) 
        self.w_conv7_3  = nn.Conv2d(self.number_f,256,3,1,1,bias=True) 
        self.w_conv8_3  = nn.Conv2d(self.number_f,256,3,1,1,bias=True) 

        # self.w_conv9 = nn.Conv2d(256,256,3,1,1,bias=True) 
        # self.w_conv10 = nn.Conv2d(256,256,3,1,1,bias=True) 
    ...
    def forward(self, inputs):
        ...
        x= laterals_pre[0]
        x_r = self.w_conv7_1(x)
        x_n = self.w_conv8_1(x)
        enhance_image_1 = (x-x_n) * (x_r)
        enhance_image_1 = self.w_conv1_1(enhance_image_1)+x
        laterals.append(enhance_image_1)

        x= laterals_pre[1]
        x_r = self.w_conv7_2(x)
        x_n = self.w_conv8_2(x)
        enhance_image_1 = (x-x_n) * (x_r)
        enhance_image_1 = self.w_conv1_2(enhance_image_1)+x
        laterals.append(enhance_image_1)

        x= laterals_pre[2]
        x_r = self.w_conv7_3(x)
        x_n = self.w_conv8_3(x)
        enhance_image_1 = (x-x_n) * (x_r)
        enhance_image_1 = self.w_conv1_3(enhance_image_1)+x
        laterals.append(enhance_image_1)
