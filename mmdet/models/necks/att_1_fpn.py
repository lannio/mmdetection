...
class ATTN_1_FPN(BaseModule):
    ...
    def __init__(self,
        ...
        super(ATTN_1_FPN, self).__init__(init_cfg)
    ...
    def forward(self, inputs):
        ...
        for i in range(5):
                ...
                level_weight_6 = self.p_6_conv(p_features[i][3])
                level_weight_7 = self.p_7_conv(p_features[i][4])
