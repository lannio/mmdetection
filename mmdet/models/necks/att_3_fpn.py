...
class ATTN_3_FPN(BaseModule):
    ...
    def __init__(self,
        ...
        super(ATTN_3_FPN, self).__init__(init_cfg)
    ...
    def forward(self, inputs):
        ...
        p_pool_all = torch.max(p_pool_3, p_pool_4)
        p_pool_all = torch.max(p_pool_all, p_pool_5) # 同p_0_3
        p_0_all = p_pool_all
