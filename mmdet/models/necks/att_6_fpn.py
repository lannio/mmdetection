...
class ATTN_6_FPN(BaseModule):
    ...
    def __init__(self,
        ...
        super(ATTN_6_FPN, self).__init__(init_cfg)
        ...
        self.w_conv7 = nn.Conv2d(self.number_f*2,4,3,1,1,bias=True) 
        self.w_conv8 = nn.Conv2d(self.number_f*2,4,3,1,1,bias=True) 
    ...
    def forward(self, inputs):
        ...
        for i in range(3):
            x= laterals_pre[i]
            x1 = self.w_relu(self.w_conv1(x))
            x2 = self.w_relu(self.w_conv2(x1))
            ...
            x_r = torch.tanh(self.w_conv7(torch.cat([x1,x2],1)))
            x_n = torch.tanh(self.w_conv8(torch.cat([x1,x2],1)))
            # r1,r2,r3,r4,r5,r6,r7,r8 = torch.split(x_r, 1, dim=1)
            # n1,n2,n3,n4,n5,n6,n7,n8 = torch.split(x_n, 1, dim=1)
            r1,r2,r3,r4 = torch.split(x_r, 1, dim=1)
            n1,n2,n3,n4 = torch.split(x_n, 1, dim=1)
